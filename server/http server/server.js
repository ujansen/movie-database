...
const fs = require("fs");
//let movies = require("../movie-database/movies.json");

const renderMovie = pug.compileFile("./views/pages/movie.pug");
const renderIndex = pug.compileFile("./views/pages/index.pug");
const renderLogin = pug.compileFile("./views/pages/login.pug");
const renderOtherUser = pug.compileFile("./views/pages/other-user.pug");
...
const server = http.createServer(function (request, response) {
    ...
    if(request.url === "/" || request.url === "/index.html") {
      let content = renderIndex({
        ...
        yourList: similarMovies,
        fanPicks: similarMovies
      });
